...
public class PopupAds : MonoBehaviour
{
	...
	public void WatchAdsx2Speed()
	{
		...
		AdmodController.instance.ShowWitchCallback(x2SpeedBooster,FailToLoadAds);
	...
	{
		GameUIManager.Instance.popupAds.SetActive(false);
		AdmodController.instance.ShowWitchCallback(x2IncomeBooster,FailToLoadAds);
	...
	public void WatchAdsCompleteShipTest()
	{
		...
		AdmodController.instance.ShowWitchCallback(CompleteShipTest,FailToLoadAds);
		Debug.Log("ShowWitchCallback");
		SendEventFirebase.ClickOnAdsEvent("ads_instant_finish_testing","Main Screen");
		Debug.Log("SendEventFirebase");
	}

	public void WatchAdsSpeedTest()
	{
		GameUIManager.Instance.popupAds.SetActive(false);
		AdmodController.instance.ShowWitchCallback(x2SpeedTest,FailToLoadAds);
		SendEventFirebase.ClickOnAdsEvent("ads_speed_testing","Main Screen");
		//x2SpeedTest();
	}
