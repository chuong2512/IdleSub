...
public class PopupLevelUp : MonoBehaviour
{
    ...
    {
        AdmodController.instance.ShowWitchCallback(Collectx2Reward, FailToLoadAds);
        GameUIManager.Instance.effMoneyUI.GetComponent<ParticleSystem>().Play();

    }
    public void Adsx5Reward()
    {
        AdmodController.instance.ShowWitchCallback(Collectx5Reward, FailToLoadAds);
        GameUIManager.Instance.effMoneyUI.GetComponent<ParticleSystem>().Play();
    }
    public void Adsx2OfflineReward()
    {
        AdmodController.instance.ShowWitchCallback(Collectx2OfflineIncome, FailToLoadAds);
        //GameUIManager.Instance.effMoneyUI.GetComponent<ParticleSystem>().Play();
        SendEventFirebase.ClickOnAdsEvent("ads_money_offlinex2", "Offline earning popup");
    }
    public void Adsx5OfflineReward()
    {
        AdmodController.instance.ShowWitchCallback(Collectx5OfflineIncome, FailToLoadAds);
        GameUIManager.Instance.effMoneyUI.GetComponent<ParticleSystem>().Play();
